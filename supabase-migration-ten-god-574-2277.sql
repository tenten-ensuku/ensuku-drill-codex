...
-- 10_20: God starts at 574pt.
-- 10_all: God starts at 2277pt.
update public.ensuku_rankings
set rank = case
  when mode_id = '10_20' then case
    when score >= 574 then '神'
...
select
  mode_id,
  count(*) filter (where mode_id = '10_20' and rank = '神' and score < 574) as invalid_10_20_god,
  count(*) filter (where mode_id = '10_20' and score >= 574 and rank <> '神') as missing_10_20_god,
  count(*) filter (where mode_id = '10_20' and score >= 574 and rank = '神') as valid_10_20_god,
  count(*) filter (where mode_id = '10_all' and rank = '神' and score < 2277) as invalid_10_all_god,
  count(*) filter (where mode_id = '10_all' and score >= 2277 and rank <> '神') as missing_10_all_god,
  count(*) filter (where mode_id = '10_all' and score >= 2277 and rank = '神') as valid_10_all_god
